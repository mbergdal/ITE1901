...
public class WeightedGraphTest {
    ...
    public void getMinimumSpanningTree() {
        ...
        double totalWeight = tree.getTotalWeight();
        assertEquals(6513.0, totalWeight, 0);
    }

    @Test
    public void getMinimumSpanningTree_fromSpecificVertex(){
        WeightedGraph<Integer> graph = new WeightedGraph<>(edges1, 5);
        WeightedGraph<Integer>.MST tree = graph.getMinimumSpanningTree(0);
        double totalWeight = tree.getTotalWeight();
        assertEquals(14.0, totalWeight, 0);
    }
}